...
START: MOV AX,@DATA
       MOV DS,AX
       DISPLAY MSG1 ;TAKE THE STRING FROM KEYBOARD CHARACTER BY CHARACTER
...
AGAIN: MOV AH,01H
       ...
       INC CL
       JMP AGAIN
NEXT:  MOV[SI],BYTE PTR '$' ;STRING INPUT OVER...
       DEC SI
       MOV CH,CL ;REVERSE THE STRING AND STORE IN RSTRING
